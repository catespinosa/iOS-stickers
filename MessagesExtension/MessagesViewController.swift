...
class MessagesViewController: MSMessagesAppViewController {
    ...
    var browserViewController: MessageBrowserViewController!
    ...
    override func viewDidLoad() {
        ...
        browserViewController = MessageBrowserViewController(stickerSize: .regular)
        
        browserViewController.view.frame = self.view.frame
        
//        browserViewController.view.backgroundColor = UIColor.red
        
      //  self.view.backgroundColor = UIColor.red
        
        //attach the childView and Controller to Parent(mobile)
